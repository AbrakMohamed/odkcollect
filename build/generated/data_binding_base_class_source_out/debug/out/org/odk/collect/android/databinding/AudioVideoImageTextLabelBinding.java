...
public final class AudioVideoImageTextLabelBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton videoButton;
  ...
  private AudioVideoImageTextLabelBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull FrameLayout textContainer, @NonNull MaterialTextView textLabel,
      @NonNull MultiClickSafeMaterialButton videoButton) {
  ...
  public static AudioVideoImageTextLabelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.videoButton;
      MultiClickSafeMaterialButton videoButton = ViewBindings.findChildViewById(rootView, id);
      if (videoButton == null) {
        break missingId;
      }
