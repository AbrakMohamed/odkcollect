...
public final class AudioControllerLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton play;

  @NonNull
  public final MultiClickSafeMaterialButton remove;
  ...
  private AudioControllerLayoutBinding(@NonNull LinearLayout rootView,
      @NonNull TextView currentDuration, @NonNull MultiClickSafeMaterialButton play,
      @NonNull MultiClickSafeMaterialButton remove, @NonNull SeekBar seekBar,
  ...
  public static AudioControllerLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.play;
      MultiClickSafeMaterialButton play = ViewBindings.findChildViewById(rootView, id);
      if (play == null) {
        break missingId;
      }

      id = R.id.remove;
      MultiClickSafeMaterialButton remove = ViewBindings.findChildViewById(rootView, id);
      if (remove == null) {
        break missingId;
      }
