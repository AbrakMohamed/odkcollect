...
public final class ProjectSettingsDialogLayoutBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton aboutButton;

  @NonNull
  public final MultiClickSafeMaterialButton addProjectButton;
  ...
  @NonNull
  public final MultiClickSafeMaterialButton generalSettingsButton;
  ...
  private ProjectSettingsDialogLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull MultiClickSafeMaterialButton aboutButton,
      @NonNull MultiClickSafeMaterialButton addProjectButton, @NonNull View bottomDivider,
      @NonNull ImageView closeIcon, @NonNull ProjectListItemView currentProject,
      @NonNull MultiClickSafeMaterialButton generalSettingsButton, @NonNull Guideline guidelineEnd,
  ...
  public static ProjectSettingsDialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MultiClickSafeMaterialButton aboutButton = ViewBindings.findChildViewById(rootView, id);
      if (aboutButton == null) {
        break missingId;
      }

      id = R.id.add_project_button;
      MultiClickSafeMaterialButton addProjectButton = ViewBindings.findChildViewById(rootView, id);
      ...
      MultiClickSafeMaterialButton generalSettingsButton = ViewBindings.findChildViewById(rootView, id);
