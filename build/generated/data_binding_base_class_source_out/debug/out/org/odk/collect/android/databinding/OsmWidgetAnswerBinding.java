...
public final class OsmWidgetAnswerBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton launchOpenMapKitButton;
  ...
  private OsmWidgetAnswerBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull MultiClickSafeMaterialButton launchOpenMapKitButton,
  ...
  public static OsmWidgetAnswerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MultiClickSafeMaterialButton launchOpenMapKitButton = ViewBindings.findChildViewById(rootView, id);
