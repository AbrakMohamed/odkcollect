...
public final class ManualProjectCreatorDialogLayoutBinding implements ViewBinding {
  ...
  private ManualProjectCreatorDialogLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull MultiClickSafeMaterialButton addButton, @NonNull AppBarLayout addProjectToolbar,
      @NonNull MultiClickSafeMaterialButton cancelButton, @NonNull ConstraintLayout configTip,
  ...
  public static ManualProjectCreatorDialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.add_button;
      MultiClickSafeMaterialButton addButton = ViewBindings.findChildViewById(rootView, id);
      if (addButton == null) {
        break missingId;
      }
