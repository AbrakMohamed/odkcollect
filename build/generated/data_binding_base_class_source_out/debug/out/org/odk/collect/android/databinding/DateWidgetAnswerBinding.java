...
public final class DateWidgetAnswerBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton dateButton;

  private DateWidgetAnswerBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialTextView dateAnswerText, @NonNull MultiClickSafeMaterialButton dateButton) {
  ...
  public static DateWidgetAnswerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.date_button;
      MultiClickSafeMaterialButton dateButton = ViewBindings.findChildViewById(rootView, id);
      if (dateButton == null) {
        break missingId;
      }
