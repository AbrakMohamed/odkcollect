...
public final class AudioRecordingControllerFragmentBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton pauseRecording;
  ...
  @NonNull
  public final MultiClickSafeMaterialButton stopRecording;
  ...
  private AudioRecordingControllerFragmentBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull MultiClickSafeMaterialButton pauseRecording, @NonNull ImageView recordingIcon,
      @NonNull LinearLayout recordingStatus, @NonNull MultiClickSafeMaterialButton stopRecording,
  ...
  public static AudioRecordingControllerFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MultiClickSafeMaterialButton pauseRecording = ViewBindings.findChildViewById(rootView, id);
      ...
      MultiClickSafeMaterialButton stopRecording = ViewBindings.findChildViewById(rootView, id);
