...
public final class OdkViewBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton launchIntentButton;
  ...
  private OdkViewBinding(@NonNull NestedScrollView rootView, @NonNull TextView groupText,
      @NonNull MultiClickSafeMaterialButton launchIntentButton,
      @NonNull NestedScrollView odkViewContainer, @NonNull LinearLayout widgets) {
  ...
  public static OdkViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MultiClickSafeMaterialButton launchIntentButton = ViewBindings.findChildViewById(rootView, id);
