...
public final class RangePickerWidgetAnswerBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton widgetButton;

  private RangePickerWidgetAnswerBinding(@NonNull LinearLayout rootView,
      @NonNull MaterialTextView widgetAnswerText,
      @NonNull MultiClickSafeMaterialButton widgetButton) {
  ...
  public static RangePickerWidgetAnswerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      MultiClickSafeMaterialButton widgetButton = ViewBindings.findChildViewById(rootView, id);
