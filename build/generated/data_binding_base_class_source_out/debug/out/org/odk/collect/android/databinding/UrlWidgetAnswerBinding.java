...
public final class UrlWidgetAnswerBinding implements ViewBinding {
  ...
  @NonNull
  public final MultiClickSafeMaterialButton urlButton;

  private UrlWidgetAnswerBinding(@NonNull LinearLayout rootView,
      @NonNull MultiClickSafeMaterialButton urlButton) {
  ...
  public static UrlWidgetAnswerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.url_button;
      MultiClickSafeMaterialButton urlButton = ViewBindings.findChildViewById(rootView, id);
      if (urlButton == null) {
        break missingId;
      }
